					...
					<div class="sign-in-form">
						...
						<div class="signin">
							...
							<div class="log-input">
								...
								<a href="#" style="color: #0C0C0C">Forgot Password ?</a>
							<input type="submit" name="submit" value="Log in">
						</form>
							<br>
							<center><h3 style="color: darkgrey">OR</h3></center>
							<center><h4 style="color: darkgrey">Sign In with</h4></center>
							<br>
							<!--<div class="footer-social-icons">-->
								<!--<ul>-->
									<!--<center><li><a class="facebook" href="#"><span>Facebook</span></a></li>-->
										<!--<li><a class="googleplus" href="#"><span>Google+</span></a></li></center>-->
								<!--</ul>-->
							<!--</div>-->
							<center><a href="#"><i class="fa fa-facebook-square" aria-hidden="true" style="font-size: 30px; color: #3b5998"></i></a>
								<a href="#"><i class="fa fa-google-plus-square" aria-hidden="true" style="font-size: 30px; color: #d34836;"></i></a></center>
